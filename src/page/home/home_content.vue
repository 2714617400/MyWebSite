    ...
    <div class="home">
        <div class="content">
            ...
            <div class="content-right">
                ...
                <div class="recommend hover-shadow">
                    <ul class="label-type de-ul">
            ...
            <!--用户信息结束-->
            <!--内容区开始-->
            <div class="content-area hover-shadow" v-for="(item, key) in content" :key="key" @click="toContent(item)">
                <h1>{{item.title}}</h1>
                <ul class="list-label label-type de-ul">
...
export default{
    ...
    methods: {
        toContent (val) {
            console.log(val)
            this.$router.push({name: 'home_details'})
        }
    }
}
</script>
...
@import '../../style/hover-shadow.less';
